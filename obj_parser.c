...
void			print(t_list *obj)
{
	while (obj)
	{
		printf("v1 %f %f %f\n", ((t_face *)obj->content)->v1.x, ((t_face *)obj->content)->v1.y, ((t_face *)obj->content)->v1.z);
		printf("v2 %f %f %f\n", ((t_face *)obj->content)->v2.x, ((t_face *)obj->content)->v2.y, ((t_face *)obj->content)->v2.z);
		printf("v3 %f %f %f\n", ((t_face *)obj->content)->v3.x, ((t_face *)obj->content)->v3.y, ((t_face *)obj->content)->v3.z);
		obj = obj->next;
	}
}
